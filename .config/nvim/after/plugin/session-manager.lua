...
require('session_manager').setup({
  ...
  autoload_mode = { config.AutoloadMode.CurrentDir, config.AutoloadMode.GitSession }, -- Define what to do when Neovim is started without arguments. See "Autoload mode" section below.
